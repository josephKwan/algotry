...
def init():
    ...
    candlesticks = client.get_historical_klines("XRPUSDT", Client.KLINE_INTERVAL_1MINUTE, "27 May, 2021", "28 May, 2021")
...
def on_message(ws, message):
    ...
    if last_rsi > RSI_OVERBOUGHT and close > five_line and close > twenty and close > fiveZero and close > twofivezero :
        if in_position:
    ...
    if last_rsi < RSI_OVERSOLD and close < five_line and close < twenty and close < fiveZero and close < twofivezero:
        if in_position:
